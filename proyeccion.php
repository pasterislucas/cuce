...
<div class="wrapper">
    ...
    <div class="main-panel">
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand">Proyecciones</a>
                </div>
        ...
        <div id='formularios'>
            <div>
                <form name="formulario" method="POST" action="proyeccion.php"> 
            <label>Nro de Dispositivo</label>
                                  ...
                                  <input style="margin-left: 10px;" type="submit" value="Consultar"> 
                                  </form>
            </div>
        </div>
            ...
            <?php
            if(isset($_POST['comboDisp'])){
                $nroDisp=$_POST['comboDisp'];
            }
            include("ejecutarEst.php");
            ?>
